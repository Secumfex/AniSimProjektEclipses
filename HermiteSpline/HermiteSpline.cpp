...
void HermiteSpline::generateArcLengthTable(int res){
	//********************************************************************************
	//hier muss die Erstellung der Bogenl�ngentabelle programmiert werden
...
void HermiteSpline::getParameterByArcLength(float length, float &u, int &patchNum){
	...
	//********************************************************************************
	//hier wird der parameter u und der entsprechende Spline f�r eine gegebene Bogenl�nge
	//in der Tabelle gesucht. Ein bin�res Suchverfahren ist zu empfehlen.
